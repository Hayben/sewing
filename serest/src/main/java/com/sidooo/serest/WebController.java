...
//	}
	...
	public @ResponseBody List<Seed> getSeedList() {
		return seedService.getSeeds();
	}

	@RequestMapping(value = "/seed/create", method = RequestMethod.POST)
	public @ResponseBody Seed createSeed(@RequestBody Seed seed) {
		seedService.createSeed(seed);
		return seed;
	}

	@RequestMapping(value = "/seed/update", method = RequestMethod.POST)
	public @ResponseBody Seed updateSeed(@RequestBody Seed seed) {
	...
	public @ResponseBody Pagination getItemList(@RequestParam String id,
		...
		return itemService.getItemList(id, pageNo, pageSize);
	}
...
//	@RequestMapping(value = "/point/network/generate", method = RequestMethod.GET)
...
//	}
	...
	@RequestMapping(value="/search", method= RequestMethod.GET)
      public @ResponseBody Network search(
    		  @RequestParam String key, 
    		  @RequestParam int depth) throws Exception {
			return pointService.search(key, depth);
      }	
	//
